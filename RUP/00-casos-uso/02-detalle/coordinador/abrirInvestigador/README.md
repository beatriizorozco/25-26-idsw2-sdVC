# FUNIBER > Coordinador > abrirInvestigador > Detalle y prototipado
...
Especificación detallada del caso de uso `abrirInvestigador()` mediante diagrama de estado, mostrando la conversación entre el Coordinador y el Sistema para presentar al coordinador el detalle de investigador y las acciones disponibles según su rol.
...
|![Caso de uso: abrirInvestigador()](/images/RUP/00-casos-uso/02-detalle/coordinador/abrirInvestigador/abrirInvestigador.svg)|
|-|
...
- abrirInvestigador(ID)
- abrirInvestigador()
- **Coordinador** solicita abrir investigador
- **Sistema** presenta perfil de investigador<br>- ID, nombre, apellido, campo, carrera, master y rol de cada investigador<br>- Permite solicitar editar perfil<br>- Permite solicitar abrirInvestigadores
...
- **Estado de entrada**: OPCIONES_PERFIL_ABIERTO, INVESTIGADORES_ABIERTOS.
- **Estado de salida**: INVESTIGADOR_ABIERTO, OPCIONES_PERFIL_ABIERTO, INVESTIGADORES_ABIERTOS, PROYECTOS_ABIERTOS.
