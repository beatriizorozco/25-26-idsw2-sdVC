# FUNIBER > Coordinador > abrirMiPublicacion > Desarrollo
...
Obtiene el detalle propio mediante `GET /api/publicaciones/me/{id}` y valida su autoría.
...
1. El Coordinador inicia `abrirMiPublicacion()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/abrirMiPublicacion/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/abrirMiPublicacion/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/abrirMiPublicacion/README.md)
