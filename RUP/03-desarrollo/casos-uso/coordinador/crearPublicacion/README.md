# FUNIBER > Coordinador > crearPublicacion > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/coordinador/crearPublicacion/README.md)|[Análisis](/RUP/01-analisis/casos-uso/coordinador/crearPublicacion/README.md)|[Diseño](/RUP/02-diseño/casos-uso/coordinador/crearPublicacion/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|
...
Crea publicaciones mediante `POST /api/publicaciones`, con archivo adjunto opcional.
...
1. El Coordinador inicia `crearPublicacion()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/crearPublicacion/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/crearPublicacion/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/crearPublicacion/README.md)
