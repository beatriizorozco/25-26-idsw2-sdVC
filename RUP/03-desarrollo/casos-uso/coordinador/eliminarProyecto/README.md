# FUNIBER > Coordinador > eliminarProyecto > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/coordinador/eliminarProyecto/README.md)|[Análisis](/RUP/01-analisis/casos-uso/coordinador/eliminarProyecto/README.md)|[Diseño](/RUP/02-diseño/casos-uso/coordinador/eliminarProyecto/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|

- **Backend:** [V7__gestion_historica_proyectos.sql](/src/backend/src/main/resources/db/migration/V7__gestion_historica_proyectos.sql) · [Proyecto.java](/src/backend/src/main/java/es/funiber/investigacion/model/Proyecto.java)
...
- `PATCH /api/proyectos/{id}/archivado`

## Implementación por capas

|Responsabilidad|Código relacionado|
|-|-|
|Persistencia|[V7__gestion_historica_proyectos.sql](/src/backend/src/main/resources/db/migration/V7__gestion_historica_proyectos.sql)|
...
1. El Coordinador inicia `eliminarProyecto()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `eliminarProyecto()` desde un estado permitido.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/eliminarProyecto/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/eliminarProyecto/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/eliminarProyecto/README.md)
