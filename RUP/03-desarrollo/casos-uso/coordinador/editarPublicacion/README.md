# FUNIBER > Coordinador > editarPublicacion > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/coordinador/editarPublicacion/README.md)|[Análisis](/RUP/01-analisis/casos-uso/coordinador/editarPublicacion/README.md)|[Diseño](/RUP/02-diseño/casos-uso/coordinador/editarPublicacion/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|
...
Actualiza cualquier publicación activa mediante `PATCH /api/publicaciones/{id}`.
...
1. El Coordinador inicia `editarPublicacion()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/editarPublicacion/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/editarPublicacion/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/editarPublicacion/README.md)
