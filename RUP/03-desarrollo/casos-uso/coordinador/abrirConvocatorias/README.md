# FUNIBER > Coordinador > abrirConvocatorias > Desarrollo
...
1. El Coordinador inicia `abrirConvocatorias()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `abrirConvocatorias()` desde un estado permitido.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/abrirConvocatorias/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/abrirConvocatorias/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/abrirConvocatorias/README.md)
