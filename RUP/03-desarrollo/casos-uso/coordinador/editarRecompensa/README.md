...
- **Backend:** [RecompensaEdicionResponse.java](/src/backend/src/main/java/es/funiber/investigacion/dto/RecompensaEdicionResponse.java) · [RecompensaService.java](/src/backend/src/main/java/es/funiber/investigacion/service/RecompensaService.java)
...
- `GET /api/recompensas/{id}/edicion`
...
|Contrato de datos|[RecompensaEdicionResponse.java](/src/backend/src/main/java/es/funiber/investigacion/dto/RecompensaEdicionResponse.java)|
...
1. El Coordinador inicia `editarRecompensa()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `editarRecompensa()` desde un estado permitido.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/editarRecompensa/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/editarRecompensa/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/editarRecompensa/README.md)
