# FUNIBER > Coordinador > abrirPublicaciones > Desarrollo
...
Consulta y filtra todas las publicaciones activas mediante `GET /api/publicaciones`.
...
1. El Coordinador inicia `abrirPublicaciones()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/abrirPublicaciones/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/abrirPublicaciones/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/abrirPublicaciones/README.md)
