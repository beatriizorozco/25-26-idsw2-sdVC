# FUNIBER > Coordinador > agregarInvestigador > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/coordinador/agregarInvestigador/README.md)|[Análisis](/RUP/01-analisis/casos-uso/coordinador/agregarInvestigador/README.md)|[Diseño](/RUP/02-diseño/casos-uso/coordinador/agregarInvestigador/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|
...
El Coordinador selecciona un perfil investigador activo que aún no participa en el proyecto. La asignación se conserva también como movimiento histórico.
...
1. El Coordinador inicia `agregarInvestigador()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `agregarInvestigador()` desde un estado permitido.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/agregarInvestigador/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/agregarInvestigador/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/agregarInvestigador/README.md)
