# FUNIBER > Coordinador > eliminarEntregable > Desarrollo
...
- `PATCH /api/entregables/{id}/retirada`
...
1. El Coordinador inicia `eliminarEntregable()` desde el estado permitido por el diagrama de contexto.
...
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/eliminarEntregable/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/eliminarEntregable/README.md)
