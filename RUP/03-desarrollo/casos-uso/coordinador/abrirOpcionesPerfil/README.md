...
1. El Coordinador inicia `abrirOpcionesPerfil()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/coordinador/abrirOpcionesPerfil/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/coordinador/abrirOpcionesPerfil/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/coordinador/abrirOpcionesPerfil/README.md)
