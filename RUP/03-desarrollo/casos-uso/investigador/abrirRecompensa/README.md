...
- **Backend:** [RecompensaController.java](/src/backend/src/main/java/es/funiber/investigacion/controller/RecompensaController.java)
...
1. El Investigador inicia `abrirRecompensa()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/investigador/abrirRecompensa/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/abrirRecompensa/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/abrirRecompensa/README.md)
