# FUNIBER > Investigador > abrirProyectos > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/abrirProyectos/README.md)|[Análisis](/RUP/01-analisis/casos-uso/investigador/abrirProyectos/README.md)|[Diseño](/RUP/02-diseño/casos-uso/investigador/abrirProyectos/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|

- **Backend:** [ProyectoRepository.java](/src/backend/src/main/java/es/funiber/investigacion/repository/ProyectoRepository.java) · [ProyectoService.java](/src/backend/src/main/java/es/funiber/investigacion/service/ProyectoService.java)
...
El Investigador consulta únicamente proyectos en los que participa, incluidos los archivados para conservar el acceso al histórico y a sus documentos. El filtro se aplica en servidor usando la identidad de la sesión.
...
1. El Investigador inicia `abrirProyectos()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `abrirProyectos()` desde un estado permitido.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/investigador/abrirProyectos/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/abrirProyectos/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/abrirProyectos/README.md)
