# FUNIBER > Investigador > abrirPublicaciones > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/abrirPublicaciones/README.md)|[Análisis](/RUP/01-analisis/casos-uso/investigador/abrirPublicaciones/README.md)|[Diseño](/RUP/02-diseño/casos-uso/investigador/abrirPublicaciones/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|
...
Consulta y filtra las publicaciones activas mediante `GET /api/publicaciones`.
...
1. El Investigador inicia `abrirPublicaciones()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `abrirPublicaciones()` desde un estado permitido.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/investigador/abrirPublicaciones/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/abrirPublicaciones/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/abrirPublicaciones/README.md)
