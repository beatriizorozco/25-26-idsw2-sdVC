# FUNIBER > Investigador > abrirEntregable > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/abrirEntregable/README.md)|[Análisis](/RUP/01-analisis/casos-uso/investigador/abrirEntregable/README.md)|[Diseño](/RUP/02-diseño/casos-uso/investigador/abrirEntregable/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|

- **Backend:** [EntregableController.java](/src/backend/src/main/java/es/funiber/investigacion/controller/EntregableController.java) · [ArchivoEntregableResponse.java](/src/backend/src/main/java/es/funiber/investigacion/dto/ArchivoEntregableResponse.java)
...
El detalle permite consultar autoría, descripción, estado y descargar cada versión del entregable dentro de un proyecto propio.
...
|Contrato de datos|[ArchivoEntregableResponse.java](/src/backend/src/main/java/es/funiber/investigacion/dto/ArchivoEntregableResponse.java)|
...
1. El Investigador inicia `abrirEntregable()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `abrirEntregable()` desde un estado permitido.
...
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/abrirEntregable/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/abrirEntregable/README.md)
