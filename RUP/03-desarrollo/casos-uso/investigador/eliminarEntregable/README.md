# FUNIBER > Investigador > eliminarEntregable > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/eliminarEntregable/README.md)|[Análisis](/RUP/01-analisis/casos-uso/investigador/eliminarEntregable/README.md)|[Diseño](/RUP/02-diseño/casos-uso/investigador/eliminarEntregable/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|

- **Backend:** [Entregable.java](/src/backend/src/main/java/es/funiber/investigacion/model/Entregable.java)
...
El Investigador solo puede retirar entregables propios. La retirada exige motivo y conserva el histórico y todas las versiones.
...
1. El Investigador inicia `eliminarEntregable()` desde el estado permitido por el diagrama de contexto.
...
2. Acceder al flujo `eliminarEntregable()` desde un estado permitido.
...
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/eliminarEntregable/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/eliminarEntregable/README.md)
