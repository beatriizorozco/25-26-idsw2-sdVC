# FUNIBER > Investigador > abrirPublicacion > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/abrirPublicacion/README.md)|[Análisis](/RUP/01-analisis/casos-uso/investigador/abrirPublicacion/README.md)|[Diseño](/RUP/02-diseño/casos-uso/investigador/abrirPublicacion/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|
...
Abre una publicación activa mediante `GET /api/publicaciones/{id}` y consulta su conversación.
...
1. El Investigador inicia `abrirPublicacion()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/investigador/abrirPublicacion/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/abrirPublicacion/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/abrirPublicacion/README.md)
