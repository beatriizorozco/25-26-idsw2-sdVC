# FUNIBER > Investigador > abrirMisPublicaciones > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/abrirMisPublicaciones/README.md)|[Análisis](/RUP/01-analisis/casos-uso/investigador/abrirMisPublicaciones/README.md)|[Diseño](/RUP/02-diseño/casos-uso/investigador/abrirMisPublicaciones/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|

- **Backend:** [PublicacionRepository.java](/src/backend/src/main/java/es/funiber/investigacion/repository/PublicacionRepository.java) · [PublicacionService.java](/src/backend/src/main/java/es/funiber/investigacion/service/PublicacionService.java)
...
Obtiene únicamente sus publicaciones activas mediante `GET /api/publicaciones/me`.
...
1. El Investigador inicia `abrirMisPublicaciones()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/investigador/abrirMisPublicaciones/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/abrirMisPublicaciones/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/abrirMisPublicaciones/README.md)
