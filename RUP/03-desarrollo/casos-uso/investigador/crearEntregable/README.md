# FUNIBER > Investigador > crearEntregable > Desarrollo

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/crearEntregable/README.md)|[Análisis](/RUP/01-analisis/casos-uso/investigador/crearEntregable/README.md)|[Diseño](/RUP/02-diseño/casos-uso/investigador/crearEntregable/README.md)|**Desarrollo**|Pruebas|
> |-|-|-|-|-|-|-|
...
Un Investigador participante puede registrar un entregable propio, con archivo inicial opcional, dentro de un proyecto visible y no archivado.
...
1. El Investigador inicia `crearEntregable()` desde el estado permitido por el diagrama de contexto.
...
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/crearEntregable/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/crearEntregable/README.md)
