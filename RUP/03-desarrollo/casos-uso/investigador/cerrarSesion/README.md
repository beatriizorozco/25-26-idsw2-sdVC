...
1. El Investigador inicia `cerrarSesion()` desde el estado permitido por el diagrama de contexto.
...
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/cerrarSesion/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/cerrarSesion/README.md)
