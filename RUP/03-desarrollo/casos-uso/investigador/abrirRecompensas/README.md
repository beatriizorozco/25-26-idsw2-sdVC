...
1. El Investigador inicia `abrirRecompensas()` desde el estado permitido por el diagrama de contexto.
...
- [Especificación detallada](/RUP/00-casos-uso/02-detalle/investigador/abrirRecompensas/README.md)
- [Análisis de colaboración](/RUP/01-analisis/casos-uso/investigador/abrirRecompensas/README.md)
- [Diseño y secuencia](/RUP/02-diseño/casos-uso/investigador/abrirRecompensas/README.md)
