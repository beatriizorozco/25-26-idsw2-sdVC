# FUNIBER > Investigador > cerrarSesion > Pruebas
...
Comprobar que el Investigador puede cancelar el cierre y permanecer en `PANEL_PRINCIPAL_ABIERTO`, o confirmarlo para volver a `SESION_CERRADA`.
