...
**Responsabilidades**:
- Recibir la solicitud `eliminarEntregable()` del Investigador.
...
- [Especificación detallada: eliminarEntregable()](/RUP/00-casos-uso/02-detalle/investigador/eliminarEntregable/README.md)
