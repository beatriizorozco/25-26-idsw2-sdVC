...
Analizar la colaboración necesaria para presentar a Investigador el listado de publicaciones, con filtrado y navegación. El análisis identifica clases Boundary, Control y Entity, sus responsabilidades y colaboraciones necesarias para cumplir con el caso de uso `abrirPublicaciones()`.

## Diagrama de colaboración

<div align=center>

|![Análisis: abrirPublicaciones()](/images/RUP/01-analisis/casos-uso/investigador/abrirPublicaciones/abrirPublicaciones-analisis.svg)|
|-|
...
**Responsabilidades**:
- Recibir la solicitud `abrirPublicaciones()` del Investigador.
...
|-|-|-|
|Atender la solicitud `abrirPublicaciones()`|`ListarPublicacionesView`|Recibe la acción del Investigador|
...
|Acceder a datos de publicaciones|`PublicacionRepository`|`obtenerPropios(investigador)`, `buscarPorCriterio(criterio)`|
...
- [Especificación detallada: abrirPublicaciones()](/RUP/00-casos-uso/02-detalle/investigador/abrirPublicaciones/README.md)
