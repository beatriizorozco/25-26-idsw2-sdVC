# FUNIBER > Investigador > abrirPublicacion > Análisis

> |[🏠️](/README.md)|[📊](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/investigador/abrirPublicacion/README.md)|**Análisis**|[Diseño](/RUP/02-diseño/casos-uso/investigador/abrirPublicacion/README.md)|[Desarrollo](/RUP/03-desarrollo/casos-uso/investigador/abrirPublicacion/README.md)|[Pruebas](/RUP/04-pruebas/casos-uso/investigador/abrirPublicacion/README.md)|
> |-|-|-|-|-|-|-|
...
Analizar la colaboración necesaria para presentar a Investigador el detalle de publicación y sus acciones disponibles. El análisis identifica clases Boundary, Control y Entity, sus responsabilidades y colaboraciones necesarias para cumplir con el caso de uso `abrirPublicacion()`.

## Diagrama de colaboración

<div align=center>

|![Análisis: abrirPublicacion()](/images/RUP/01-analisis/casos-uso/investigador/abrirPublicacion/abrirPublicacion-analisis.svg)|
|-|
...
**Responsabilidades**:
- Recibir la solicitud `abrirPublicacion()` del Investigador.
...
|-|-|-|
|Atender la solicitud `abrirPublicacion()`|`DetallePublicacionView`|Recibe la acción del Investigador|
...
- [Especificación detallada: abrirPublicacion()](/RUP/00-casos-uso/02-detalle/investigador/abrirPublicacion/README.md)
