...
Analizar la colaboración necesaria para autenticar al Investigador. El análisis identifica clases Boundary, Control y Entity, sus responsabilidades y colaboraciones necesarias para cumplir con el caso de uso `iniciarSesion()`.
...
**Responsabilidades**:
- Recibir la solicitud `iniciarSesion()` del Investigador.
...
|-|-|-|
|Atender la solicitud `iniciarSesion()`|`IniciarSesionView`|Recibe la acción del Investigador|
...
- [Especificación detallada: iniciarSesion()](/RUP/00-casos-uso/02-detalle/investigador/iniciarSesion/README.md)
