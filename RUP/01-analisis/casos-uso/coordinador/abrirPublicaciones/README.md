# FUNIBER > Coordinador > abrirPublicaciones > Analisis

> |[Inicio](/README.md)|[Contexto](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/coordinador/abrirPublicaciones/README.md)|**Analisis**|[Diseno](/RUP/02-dise%C3%B1o/casos-uso/coordinador/abrirPublicaciones/README.md)|Desarrollo|Pruebas|
> |-|-|-|-|-|-|-|
...
|![Analisis: abrirPublicaciones()](/images/RUP/01-analisis/casos-uso/coordinador/abrirPublicaciones/abrirPublicaciones-analisis.svg)|
|-|
|Codigo fuente: [colaboracion.puml](colaboracion.puml)|

## Responsabilidades

- **abrirPublicacionesView**: Presenta la conversacion y captura las decisiones del Coordinador.
