...
Analizar la colaboración necesaria para presentar a Coordinador el detalle de publicación propia y sus acciones disponibles. El análisis identifica clases Boundary, Control y Entity, sus responsabilidades y colaboraciones necesarias para cumplir con el caso de uso `abrirMiPublicacion()`.

## Diagrama de colaboración

<div align=center>

|![Análisis: abrirMiPublicacion()](/images/RUP/01-analisis/casos-uso/coordinador/abrirMiPublicacion/abrirMiPublicacion-analisis.svg)|
|-|
...
**Responsabilidades**:
- Recibir la solicitud `abrirMiPublicacion()` del Coordinador.
...
|-|-|-|
|Atender la solicitud `abrirMiPublicacion()`|`DetallePublicacionView`|Recibe la acción del Coordinador|
...
- [Especificación detallada: abrirMiPublicacion()](/RUP/00-casos-uso/02-detalle/coordinador/abrirMiPublicacion/README.md)
