...
|![Analisis: abrirMiPublicacion()](/images/RUP/01-analisis/casos-uso/coordinador/abrirMiPublicacion/abrirMiPublicacion-analisis.svg)|
|-|
|Codigo fuente: [colaboracion.puml](colaboracion.puml)|

## Responsabilidades

- **abrirMiPublicacionView**: Presenta la conversacion y captura las decisiones del Coordinador.
