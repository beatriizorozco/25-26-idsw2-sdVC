...
**Responsabilidades**:
- Recibir la solicitud `crearEntregable()` del Coordinador.
...
|-|-|-|
|Atender la solicitud `crearEntregable()`|`CrearEntregableView`|Recibe la acción del Coordinador|
...
- [Especificación detallada: crearEntregable()](/RUP/00-casos-uso/02-detalle/coordinador/crearEntregable/README.md)
