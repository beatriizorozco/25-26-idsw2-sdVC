...
|![Análisis: responderPublicacion()](/images/RUP/01-analisis/casos-uso/coordinador/responderPublicacion/responderPublicacion-analisis.svg)|
|-|
...
**Responsabilidades**:
- Recibir la solicitud `responderPublicacion()` del Coordinador.
...
|-|-|-|
|Atender la solicitud `responderPublicacion()`|`ResponderPublicacionView`|Recibe la acción del Coordinador|
...
- [Especificación detallada: responderPublicacion()](/RUP/00-casos-uso/02-detalle/coordinador/responderPublicacion/README.md)
