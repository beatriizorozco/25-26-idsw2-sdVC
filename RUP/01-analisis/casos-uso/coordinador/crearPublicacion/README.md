# FUNIBER > Coordinador > crearPublicacion > Analisis

> |[Inicio](/README.md)|[Contexto](/RUP/00-casos-uso/01-actores-casos-uso/diagramas-contexto.md)|[Detalle](/RUP/00-casos-uso/02-detalle/coordinador/crearPublicacion/README.md)|**Analisis**|[Diseno](/RUP/02-dise%C3%B1o/casos-uso/coordinador/crearPublicacion/README.md)|Desarrollo|Pruebas|
> |-|-|-|-|-|-|-|
...
|![Analisis: crearPublicacion()](/images/RUP/01-analisis/casos-uso/coordinador/crearPublicacion/crearPublicacion-analisis.svg)|
|-|
|Codigo fuente: [colaboracion.puml](colaboracion.puml)|

## Responsabilidades

- **crearPublicacionView**: Presenta la conversacion y captura las decisiones del Coordinador.
...
- [Detalle](/RUP/00-casos-uso/02-detalle/coordinador/crearPublicacion/README.md)
